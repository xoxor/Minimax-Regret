...
It is natural to look at methods from social choice and see how they can be adapted for group decision-making in a computerized setting.
...
This observation has motivated a number of recent works \cite{Xia2008,Kalech2011,Lu2011,Naamani-Dery2015} on preference elicitation in a voting context. % including several works on social choice with partial profiles.
...
In a similar way,  Cailloux and Endriss \cite{Cailloux2014} have argued that it might not always be realistic to assume that a voting rule is known precisely.
