...
In the classical setting, the voting rule is fixed beforehand, and the full preference information is provided by the voters. 

%As social choice moves to the web, the
%the need for relaxing the assumptions of classical social choice
...
We then show how minimax regret can be used to drive the elicitation in order to ask informative queries in order to 
