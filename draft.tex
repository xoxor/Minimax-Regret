...
The results are displayed in \cref{fig:xp1,fig:xp2,fig:xp3}. In these tables, the strategies are designated by Rnd for Random, T. ph. for Two phases, EC for Extreme completions, and Pes. for Pessimistic.
