...
Indeed, it can be beneficial to interleave questions asked to the chair and questions asked to voters, depending on which is estimated to be more informative.
...
%{\em if} condition {\em then} ask comparison query {\em else} ask a chair query
