...
\ifijcai
	...
	\affiliations $^1$ LAMSADE, CNRS and Dauphine University, PSL, Paris, France\\ $^2$ LIP6, UMR 7606, CNRS and Sorbonne Universit\'e, Paris, France
...
%We want to design a questioning strategy to minimize the worst regret in the long run
% A questioning strategy indicates, given a partial profile and a set of feasible weights, which question to ask next. A question is either a query to the voter $i$ about her preference relation $\succ_i$ or a query to the committee about the feasible weights. 
...
% we define a model that allows simultaneous elicitation of the voting rule and user preferences, making appropriate tradeoffs be- tween the two types of information
