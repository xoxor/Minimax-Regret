...
%\author{}
\author{Olivier Cailloux \and Stefano Moretti \and Beatrice Napolitano \and Paolo Viappiani} %\affil{LIP6\\\email{paolo.viappiani@lip6.fr}
...
\item References: \cite{Cailloux2014}, \cite{Llamazares2013}, \cite{Konczak05}, \cite{Kalech2011}, \cite{Pini2009}
\end{itemize}
...
% Given partial information about voter preferences, how does one choose a suitable approximate winner? 
...
%which queries to ask of which voters. 
