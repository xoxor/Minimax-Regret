...
While it is of course possible to first fully elicit the agent preferences and afterwards elicit weights, we also want to propose interleaved approaches and compare them experimentally.
