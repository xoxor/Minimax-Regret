...
that, on average, halving the number of questions will only reduce the gain in regret by less than half.% do less harm than halving the gain in regret, on average.
