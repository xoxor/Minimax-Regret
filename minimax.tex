...
\begin{example*}
	...
	We show the profile in Figure xx, left, to the chair and ask who should win (each column is a preference of an agent).
	\begin{center}
		$
	...
	Figure xx, right, shows the same profile using a compressed view, the numbers in bold indicating the number of voters (agents?) having the preference in the corresponding column. As the proof shows, constructed profiles require only four different linear orders.
	\begin{center}
		$
		\begin{array}{cccc}
