...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\begin{axis}[
			...
			\addlegendimage{mark=oplus*,blue,mark size=2}
			\addlegendimage{mark=pentagon*,cyan,mark size=2}
			\addlegendimage{mark=halfsquare left*,pink,mark size=2}
			...
			\addplot[thick, mark=oplus*, mark size = {2}, mark indices = {60}, blue] table [x=k, y=14.9]{data/linearity.dat};
			...
			\addplot[thick, mark=halfsquare left*, mark size = {2}, mark indices = {200}, pink] table [x=k, y=sushi]{data/linearity.dat};
			\addlegendentry{sushi m10n30}
