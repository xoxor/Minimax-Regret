...
We compare the effectiveness of several questioning strategies based on the current knowledge of the rule and preferences. To summarize our contributions:
\begin{itemize}
	...
	\item we show that %in small problem sizes, %starting with zero knowledge,
	 it is possible to reach a low regret level with a reasonable number of questions;
