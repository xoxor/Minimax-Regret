...
We are now faced with the problem of aggregating these values to determine the informative value of the question. Motivated by  \citet{Cailloux2014} we adopt a pessimistic approach, reported to perform better than optimistic aggregation, although our experiments in this context suggested a weak impact of that choice on the performance of the strategy.
