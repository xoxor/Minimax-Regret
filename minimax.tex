...
Although more interest has been shown in the incompleteness of agent preferences, several authors have considered scenarios where the voting rule is partially defined. Among others, \citet{Llamazares2013} have considered the problem of dealing with variable weights in positional scoring rules, and \citet{Stein1994,Viappiani2018} consider the uncertainty in weights of a positional scoring rule assuming that the agents preferences are known. 

Studies related to the manipulability of voting rules have been proposed in this context \citep{Elkind2012,Dey2018,Dey2018_2,Conitzer2011}, and strategic behaviors, when agents learn incrementally about other agents preferences, have been investigated \citep{Endriss2016,Lev2019,Annemieke2012}.
