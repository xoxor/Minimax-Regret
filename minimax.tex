...
We also see that Extended pessimistic performs slightly less well than Pessimistic. Although they come close, Pessimistic performs significantly better, in the sense that the numbers are consistently in favor of Pessimistic if running the experiment again.
...
\begin{table}
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Average $\MMR$ in problems of size $(10, 20)$ after $400$ questions. Where $p$ represents the number of questions asked to the chair.}
	\label{tab:twoP400}
\end{table}
