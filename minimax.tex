...
%			xlabel=Number of Questions,
%			ylabel=Avg. Regret,
%			ytick={0,5,10,15,20,25,30,35,146},
%			xtick distance=100,
%			ytick distance=5,
%			xtick pos=left,
%			ymajorgrids=true,
...
%			xmin=0,
%			xmax=1000,
%			yticklabels={0,5,10,15,20,25,30,35,146}]
%			
...
%			\addplot[thick, mark=halfsquare right*, mark size = {2}, mark indices = {400}, brown] table [x=k, y=courses]{data/linearity.dat};
...
\begin{figure}
	\caption{Logarithmic plot representing the MMR reduction after $k$ questions with Pessimistic strategy for different problem sizes.}
	\label{fig:linearity}
	\begin{tikzpicture}
		\pgfplotsset{
			every axis legend/.append style={
		...
		\begin{semilogyaxis}[
			...
			ymin=10e-2,
			ymax=10e2,
			ytick={10e-2,1,2,10,15,20,30,146},
			yticklabels={0.01,1,2,10,15,20,30,146},
			ymajorgrids=true,
			ytick style={draw=none},
			xmin=0,
			xmax=1000,
			...
			\addplot[thick, mark=triangle*, mark size = {2}, mark indices = {35}, teal, domain=-5:5] table [x=k, y=5.10]{data/linearity.dat};
			\addlegendentry{m=5, n=10}
			\addplot[thick, mark=*, mark size = {2}, mark indices = {45}, violet,domain=-5:5] table [x=k, y=5.15]{data/linearity.dat};
			\addlegendentry{m=5, n=15}
			\addplot[thick, mark=square*, mark size = {2}, mark indices = {90}, green] table [x=k, y=5.20]{data/linearity.dat};
			\addlegendentry{m=5, n=20}
			\addplot[thick, mark=diamond*, mark size = {2}, mark indices = {150}, red] table [x=k, y=10.20]{data/linearity.dat};
