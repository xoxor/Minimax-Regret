...
As part of our contribution, we provide an open-source library \url{https://github.com/oliviercailloux/minimax}, to reproduce our experiments and perform many more.
%will be made publicly available.(URL not displayed for reasons of anonymity.)
