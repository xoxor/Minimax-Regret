...
Our first experimental result concerns small size situations. We picked $m = 5, n = 10$ to illustrate our results (variations around these sizes yield similar conclusions). 
...
Note that this may underestimate the number of questions required to determine completely the profile and the rule, as these questions yield no information about the scoring vector.
...
The experiments so far let the strategy decide the target of its questions, leaving the possibility to question the chair or the agents at each step. It may be desired in practical implementations to restrict the strategy to ask questions to agents only, or mostly, or to wonder what is lost in terms of regret by asking more questions to the chair. That may be because of unavailability of the chair, or because the estimated cognitive costs may differ sensibly, as these types of questions differ in nature.
