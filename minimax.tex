...
\commentBN{here are two examples of situations. (divide in two par)}
...
Observe that if $\MMR(\pprofile, W)\!=\!0$, then any $x^{*}_{\pprofile,W} \in A^*_{\pprofile, W}$ is a necessary winner: any valid completion of $\pprofile$ and any choice of $w \in W$ gives to $x^{*}_{\pprofile,W}$ the highest score.
